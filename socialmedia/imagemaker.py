...
def add_watermark(img, watermark_path='lf_logo.png', scale = 1.1, opacity=0.85, brightness=1.1 , contrast=1.5):
    ...
    watermark = ImageEnhance.Contrast(watermark).enhance(contrast)
